...
describe('CartPage test', () => {
    const fakeCartItems = [{id: 1, name: 'item1', price: 100, quantity:1}, {id: 2, name: 'item2', price: 23, quantity:2}];
    ...
    it('should display Cart is empty', async () => {
        ...
        const {queryByTestId, queryByText} = renderRedux(<CartPage />, {initialState: {cart: initialState}});
    ...
    it('should fetch data from server', async () => {
        ...
        const {findByTestId, getAllByTestId, queryByTestId} = render(<Provider store={store}><CartPage /></Provider>);
    ...
    it('should open modal with form by click on `add cart item` btn', async () => {
        ...
        const {queryByTestId, queryByText} = renderRedux(
    ...
    it('test delete btn', () => {
        ...
        const {queryAllByTestId} = renderRedux(
            <CartPage/>, {initialState: {cart: initialState}});
