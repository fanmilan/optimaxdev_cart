...
describe('form test', () => {
    ...
    it('test required errors', () => {
        const { getByTestId, getByText, queryAllByText } = render(<Form {...props} />);
    ...
    it('test min value validation for price and quantity', () => {
        ...
        expect(queryByText('This field should be greater then 0')).toBeInTheDocument();
        expect(queryByText('This field should be greater or equal then 1')).toBeInTheDocument();
        ...
        //Shouldn't be error
        expect(queryByText('This field should be greater or equal then 1')).not.toBeInTheDocument();
        expect(queryByText('This field should be greater then 0')).not.toBeInTheDocument();
